...
import { sellProductsSuccess, sellProductsFailure } from '../../../actions/products/sellProducts'; // Update the import to the correct sell actions
...
export const sellProductsSaga = {
  saga: function* (action: { type: string, payload: { company: string, type: string, filterArray: SellFilterInput[] } }) {
    try {
