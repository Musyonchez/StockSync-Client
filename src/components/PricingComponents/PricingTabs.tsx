  ...
  return (
    <div className=" p-3">
      <div className=" flex flex-col justify-center items-center">
        <h1 className=" font-bold text-8xl mb-4 text-emerald-300 dark:text-white">
          Pricing
        </h1>
        <p className=" text-center text-emerald-800 dark:text-white">
          Unlock the full potential of StockSync Innovations with our flexible
          pricing plans.
        </p>
        <p className=" text-center text-emerald-800 dark:text-white pt-2 px-2">
          Choose the one that best fits your business needs and takes your
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 xl:flex xl:flex-row justify-center">
        ...
        <div className=" bg-slate-100 dark:bg-gray-900 space-y-5 p-5 mx-5 mb-10">
          ...
          <p>
            Starting at{" "}
            <span className=" font-bold text-3xl">{getPriceBasic()}</span>
            {getPeriod()}
          </p>
          <hr />
          <p>Features</p>
        ...
        <div className=" bg-red-200 dark:bg-pink-800 space-y-5 p-5 mx-5 mb-10">
          ...
          <p>
            Starting at{" "}
            <span className=" font-bold text-3xl">{getPricePro()}</span>
            {getPeriod()}
          </p>
          <hr />
          <p>Features</p>
          <p className=" flex">
            ...
            <span className=" ml-2"></span>All features in the Basic Plan
          </p>
          <p className=" flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className=" ml-2"></span>Real-time updates on stock movements
          </p>
          <p className=" flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className=" ml-2"></span>Enhanced reporting and analytics
          </p>
          <div className=" flex flex-col items-center">
            <button className=" bg-black w-full text-white px-4 py-2">
              <Link href="/contact">Upgrade</Link>
        ...
        <div className=" bg-emerald-300 dark:bg-emerald-800 space-y-5 p-5 mx-5 mb-10">
          ...
          <p>
            Starting at{" "}
            <span className=" font-bold text-3xl">{getPriceEnterprise()}</span>
            {getPeriod()}
          </p>
          <hr />
          <p>Features</p>
          <p className=" flex">
            ...
            <span className=" ml-2"></span>All features in the Pro Plan
          </p>
          <p className=" flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className=" ml-2"></span>Supplier integration
          </p>
          <p className=" flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className=" ml-2"></span>Multi-channel synchronization
          </p>
          <div className=" flex flex-col items-center">
            <button className=" bg-black w-full text-white px-4 py-2">
              <Link href="/contact">Upgrade</Link>
