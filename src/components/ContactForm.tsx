    ...
    <>
      <div className=" hidden md:flex flex-row h-full my-auto justify-between">
        <div className="flex flex-col flex-1 md:pl-10 lg:pl-28 lg:pt-14">
          ...
          <p className="text-lg mb-6 text-gray-700 dark:text-gray-300">
            We are here to assist you, and we would be <br /> delighted to
            connect with you for any queries or concerns.
          </p>
      ...
      <div className="flex md:hidden flex-col items-center h-full my-auto justify-between px-4">
        ...
        <form className="space-y-3 w-full" onSubmit={sendEmail} ref={form}>
          ...
          <button
            className="bg-emerald-500 px-4 py-2 rounded-full text-white w-full"
            type="submit"
          >
            Send Message &rarr;
          </button>
