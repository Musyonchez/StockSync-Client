...
const VerticalNavbar = () => {
  ...
  return (
    <div className="pt-2 pl-2 min-w-40 bg-gray-100 dark:bg-black h-screen overflow-x-hidden overflow-y-auto scrollbar">
      <Link href="/">
      ...
      <div className="mb-4">
        ...
        <ul className="ml-2 flex flex-col space-y-2">
          ...
          <li className="flex space-x-3" onClick={handleLogout}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
