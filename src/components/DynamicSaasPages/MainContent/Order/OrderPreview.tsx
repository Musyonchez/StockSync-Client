...
doc.addImage(logoUrl, 'PNG', logoxCoordinate, logoyCoordinate, logoimageWidth, logoimageHeight);
...
doc.text(totalAmount.toString(), 175, totalPositiony + 5, { maxWidth: 45 });
...
doc.text(grandTotal.toString(), 175, totalPositiony + 20, { maxWidth: 45 });
} else {
  doc.setFontSize(12);
